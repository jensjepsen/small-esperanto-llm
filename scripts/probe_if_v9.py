"""Probe an SFT checkpoint against `jensjepsen/danish-instruction-following-v3:default:eval`.
...
def main():
    ...
    ap.add_argument("--tokenizer", default=None,
                    help="Defaults to --checkpoint. Load from the ckpt dir "
                         "for post-SFT models — the base danish-tokenizer "
                         "on HF lacks the chat special tokens.")
    ...
    ds = load_dataset("jensjepsen/danish-instruction-following-v3",
                      "default", split="eval")
